...
import { ArrowLeft, Calendar, Clock, Copy, List, Mail, MessageCircle, MessageCircleIcon, MessageCircleReply, Plus } from 'lucide-react';
        ...
        <div className='w-full p-7 mt-6 rounded-lg bg-white'>
            ...
            <div className='mt-7 bg-white p-5 rounded-lg w-full'>
                ...
                <div className='flex gap-7 mt-2 justify-between'>
                    ...
                    <Button variant={'outline'} ><MessageCircleIcon />Slack</Button>
                    <Button variant={'outline'} ><MessageCircleReply />WhatsApp</Button>
                </div>
            </div>
            <div className='flex w-full gap-5 justify-between mt-6'>
                ...
                <Link href={'/create-interview'}>
                    <Button variant={'outline'} > <Plus /> Create New Interview</Button>
                </Link>
            </div>
        </div>
    </div>
